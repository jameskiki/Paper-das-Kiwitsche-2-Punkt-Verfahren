...
demonstrate that KZV-IMC achieves zero overshoot and an IAE within \SI{3}{\percent}
of the theoretically optimal IMC controller, while Ziegler--Nichols tuning
yields \SI{57.8}{\percent} overshoot and more than twice the IAE.
